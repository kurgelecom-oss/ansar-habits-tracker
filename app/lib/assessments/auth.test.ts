...
describe('assessment authentication',()=>{
 ...
 it('separates learner and parent-practice session purposes',()=>{
  const learner=signSession(2000,'learner');const practice=signSession(2000,'practice');
  expect(validSession(learner,1000,'learner')).toBe(true);
  expect(validSession(learner,1000,'practice')).toBe(false);
  expect(validSession(practice,1000,'practice')).toBe(true);
  expect(validSession(practice,1000,'learner')).toBe(false);
 });
